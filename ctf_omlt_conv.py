...
def ctf_evaluate():
    ...
    onnx_path_bounded = config.CONV_MNIST_PATH_BOUNDS
    ...
    ctf_output_path = "results/final/omlt/ctf_conv_mnist.csv"
    ...
    for i in range(iterations):
        ...
        pyo_solver.write(f"omlt_conv_debug_{i}.lp")
        ...
        results.append({
            ...
            "grb_ObjectiveValue": native_model.objective_value,
            "grb_MIPGap": gap,
